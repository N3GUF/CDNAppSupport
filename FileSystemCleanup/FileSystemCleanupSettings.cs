...
namespace Comdata.AppSupport.FileSystemCleanup
{
    public class FolderSetting
    {
        ...
        public FolderSetting(string folder, string archivePath, bool includeSubfolders, int archiveAfterDDays, int compressAfterDDays
                             , int deleteAfterMonths, bool deleteEmptyFolders, List<string> exclusions)
        {
            this.Folder = folder;
            this.ArchivePath = archivePath;
            this.IncludeSubfolders = includeSubfolders;
            this.ArchiveAfterDays = archiveAfterDDays;
            this.CompressAfterDays = compressAfterDDays;
            this.DeleteAfterMonths = deleteAfterMonths;
    ...
    public class FileSystemCleanupSettings : ISettings
    {
        ...
        public void Create()
        {
            ...
            Exclusions.Add("test");
            this.FoldersToCleanup.Add(new FolderSetting(@"C:\Users\dbernhardy\Downloads", @".\Archive", false, 1, 30, 24, true, Exclusions));
